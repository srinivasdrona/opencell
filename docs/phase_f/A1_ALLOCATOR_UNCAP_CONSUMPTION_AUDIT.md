...
| transcription_v3 | `opencell/vivarium/karr_transcription_v3.py:165,167` | CEILING | `consumed = min(per_ntp_need, budget)`<br>`out[ntp] = -consumed` | Each NTP delta is a direct clamp of desired demand against allocated budget. | SAFE |
