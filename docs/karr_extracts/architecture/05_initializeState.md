# Karr Architecture - initializeState

**Primary source:** `data/m1_sources/WholeCell/src/+edu/+stanford/+covert/+cell/+sim/@Simulation/initializeState.m`

---

## Verbatim extract - method header docstring

```

```

## Verbatim extract - `initializeState` implementation
