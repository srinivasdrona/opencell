...
_TRACE_PROCESS_NAME = "Replication"
...
def test_karr_replication_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = KarrReplicationProcess({"rng_seed": int(rng_seed)})
