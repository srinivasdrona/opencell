...
_TRACE_PROCESS_NAME = "tRNAAminoacylation"
_OBSERVABLES = ('substrates', 'enzymes', 'boundEnzymes', 'freeRNAs', 'aminoacylatedRNAs')
...
_OBSERVABLE_TO_WIDS_ATTR = {'substrates': 'substrate_wids', 'enzymes': 'enzyme_wids', 'boundEnzymes': 'enzyme_wids', 'freeRNAs': 'free_rna_wids', 'aminoacylatedRNAs': 'aminoacylated_rna_wids'}
...
def test_karr_trna_aminoacylation_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = KarrTRNAAminoacylationProcess({"rng_seed": int(rng_seed)})
