...
def test_karr_transcriptional_regulation_l2_event_replay(rng_seed: int) -> None:
    """L2 replay on an event-window trace. TranscriptionalRegulation shows no
    boundTFs/tfBoundPromoters deltas in the first 100 ticks; the fixed 4000-tick
    window gives TF binding kinetics more simulated time to produce an event."""
