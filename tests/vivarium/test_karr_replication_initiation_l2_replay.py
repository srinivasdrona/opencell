...
_TRACE_PROCESS_NAME = "ReplicationInitiation"
...
def test_karr_replication_initiation_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = KarrReplicationInitiationProcess({"rng_seed": int(rng_seed)})
