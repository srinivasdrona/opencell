...
_TRACE_PROCESS_NAME = "Translation"
...
def test_karr_translation_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = KarrTranslationV3Process({"rng_seed": int(rng_seed)})
