...
_TRACE_PROCESS_NAME = "MacromolecularComplexation"
_OBSERVABLES = ('substrates', 'enzymes', 'boundEnzymes', 'complexs')
...
_OBSERVABLE_TO_WIDS_ATTR = {'substrates': 'substrate_wids', 'enzymes': 'enzyme_wids', 'boundEnzymes': 'enzyme_wids', 'complexs': 'complex_wids'}
...
def test_karr_macromolecular_complexation_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = MacromolecularComplexationProcess({"rng_seed": int(rng_seed)})
