...
_TRACE_PROCESS_NAME = "ProteinFolding"
_OBSERVABLES = ('substrates', 'enzymes', 'boundEnzymes', 'foldedMonomers', 'unfoldedMonomers')
...
_OBSERVABLE_TO_WIDS_ATTR = {'substrates': 'substrate_wids', 'enzymes': 'enzyme_wids', 'boundEnzymes': 'enzyme_wids', 'foldedMonomers': 'folded_monomer_wids', 'unfoldedMonomers': 'unfolded_monomer_wids'}
...
def test_karr_protein_folding_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = KarrProteinFoldingProcess({"rng_seed": int(rng_seed)})
