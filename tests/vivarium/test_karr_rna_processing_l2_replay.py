...
_TRACE_PROCESS_NAME = "RNAProcessing"
_OBSERVABLES = ('substrates', 'enzymes', 'boundEnzymes', 'processedRNAs', 'unprocessedRNAs')
...
_OBSERVABLE_TO_WIDS_ATTR = {'substrates': 'substrate_wids', 'enzymes': 'enzyme_wids', 'boundEnzymes': 'enzyme_wids', 'processedRNAs': 'processed_rna_wids', 'unprocessedRNAs': 'unprocessed_rna_wids'}
...
def test_karr_rna_processing_l2_replay_identity_per_tick(rng_seed: int) -> None:
    ...
    with h5py.File(trace_path, "r") as trace:
        ...
        process = KarrRNAProcessingProcess({"rng_seed": int(rng_seed)})
