...
def _build_calc() -> RequestCalculatorMetabolism:
    ...
    return RequestCalculatorMetabolism({"metabolism_proc": proc})
...
def test_request_calculator_metabolism_includes_ngam_floor() -> None:
    calc = _build_calc()
...
def test_request_calculator_metabolism_scales_with_tick() -> None:
    calc = _build_calc()
