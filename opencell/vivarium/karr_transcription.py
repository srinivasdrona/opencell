"""Karr transcription -- Karr-light port of MATLAB +process/Transcription.m
...
This declaration also applies to `karr_transcription_v3.py` and
`karr_transcription_v2.py`.
