...
- TOML schema spec v2 drafted + 3 critique rounds (Sonnet, GPT-5.4, Gemini 3.5). Key decisions: fixture-first extraction, species_pools pattern, remove store_path, keep TOMLs autogenerated.
