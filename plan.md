...
- **Gate verdict: PASS (diverge_cells=0)** — vocab 28/28 CONFORM (ordered), stoich 6 CONFORM (incl. Metabolism FBA) + 22 N/A (signed), state-usage + constants INFO. Self-tests: `tests/integration/test_gate2_oc_vs_spec_gate.py` (4 pass). **CI-wired blocking** as `gate2-oc-vs-spec` (`bbdff07`).
